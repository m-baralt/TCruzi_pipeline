...
for dir in data/lit_pcba/*/; do
    target=$(basename "$dir")
    MOL_PATH="${dir}/mols.lmdb" # "/home/mabarr/TCruzi_pipeline/test/chembl_smiles.lmdb"
    POCKET_PATH="${dir}/pockets.lmdb"  #"/home/mabarr/TCruzi_pipeline/test/8OZZ.lmdb" 
    save_path="/home/mabarr/TCruzi_pipeline/threshold_experiments/normalizing_litpcba/${target}.txt"
